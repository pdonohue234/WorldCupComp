				...
				<form:form method="post" action="/updatePredictions" modelAttribute="fixtureResultList">   
					...
					<div class="Grid-cell-center">
						<c:if test="${model.userLoggedIn ne undefined && model.userLoggedIn.userId ne undefined && model.userLoggedIn.privateCompName ne ''}">
							<a href="javascript:miniGroupTable('${model.userLoggedIn.userId}','${model.userLoggedIn.privateCompName}');"> <u>Mini Competition Leaderboard</u>)</a>
						</c:if>	
						<br>
					...
					<div id="hiddenText" class="Grid-cell-center" style="display:none; text-align:center; font-style:italic; font-size:0.8em;">
						...
						<br>2 points are awarded for each correct team score prediction (max of 4pts available in each game)
						...
						<br>Predictions are for the 90 minutes of normal play. Extra time or penalties are not included
					</div>
